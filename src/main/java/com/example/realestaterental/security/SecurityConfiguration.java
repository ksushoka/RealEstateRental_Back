        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .antMatchers("/properties", "/properties/photos/**", "/users/all",
                                ...
                                "/users/properties", "/review/save/**", "/properties/**",
                                "/properties/description/**", "/properties/update").permitAll()
...
//    }
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(List.of(
                "http://localhost:3000",
                "https://realestaterental-8ce5c.web.app",
                "https://realestaterental-8ce5c.firebaseapp.com"
        ));
